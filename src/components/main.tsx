    ...
    <div className="w-full flex flex-col items-center mt-20">
      <div className="max-w-md text-center">
        <h1
          ...
          className="relative font-display text-4xl font-extrabold leading-[1.15] text-black sm:text-5xl sm:leading-[1.15]"
        >
          <span className="bg-gradient-to-r from-violet-800 via-fuchsia-800 to-rose-400 bg-clip-text text-transparent">
